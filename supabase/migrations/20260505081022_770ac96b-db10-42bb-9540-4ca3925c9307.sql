...
CREATE TABLE public.profiles (
  ...
  notes TEXT, address_line1 TEXT, address_line2 TEXT, city TEXT, state TEXT,
  postal_code TEXT, country TEXT, dob DATE, id_number TEXT,
...
CREATE TABLE public.market_assets (
  ...
  coingecko_id TEXT, deposit_address TEXT, icon_url TEXT,
...
CREATE TABLE public.deposits (
  ...
  tx_hash TEXT, proof_url TEXT,
  status public.tx_status NOT NULL DEFAULT 'pending',
  admin_note TEXT, usd_amount NUMERIC(28,8), pay_coin TEXT, pay_amount NUMERIC(28,8),
  rate_used NUMERIC(28,8), fee_pct NUMERIC(8,4) DEFAULT 0, usd_credited NUMERIC(28,8),
...
CREATE TABLE public.withdrawals (
  ...
  status public.tx_status NOT NULL DEFAULT 'pending',
  admin_note TEXT, usd_amount NUMERIC(28,8), payout_coin TEXT, payout_amount NUMERIC(28,8),
  rate_used NUMERIC(28,8), fee_pct NUMERIC(8,4) DEFAULT 0,
  created_at TIMESTAMPTZ NOT NULL DEFAULT now(), processed_at TIMESTAMPTZ
);
...
CREATE TABLE public.staking_plans (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  name TEXT NOT NULL, coin TEXT NOT NULL,
  apy NUMERIC(6,2) NOT NULL, lock_days INT NOT NULL,
  min_amount NUMERIC(28,8) NOT NULL DEFAULT 0,
  max_amount NUMERIC(28,8), fixed_amount NUMERIC(28,8),
  description TEXT, is_usd BOOLEAN NOT NULL DEFAULT false,
  active BOOLEAN NOT NULL DEFAULT true,
  created_at TIMESTAMPTZ NOT NULL DEFAULT now(),
  updated_at TIMESTAMPTZ NOT NULL DEFAULT now()
);
...
CREATE TABLE public.trade_records (
  ...
  pair TEXT NOT NULL, side public.trade_side NOT NULL,
  amount NUMERIC(28,8) NOT NULL,
  entry_price NUMERIC(28,8) NOT NULL,
  exit_price NUMERIC(28,8), pnl NUMERIC(28,8),
...
CREATE TABLE public.signals (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  title TEXT NOT NULL, pair TEXT NOT NULL, side public.trade_side NOT NULL,
  entry NUMERIC(28,8) NOT NULL, target NUMERIC(28,8), stop NUMERIC(28,8),
  notes TEXT,
...
CREATE TABLE public.transaction_history (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  user_id UUID NOT NULL REFERENCES auth.users(id) ON DELETE CASCADE,
  type TEXT NOT NULL, coin TEXT, amount NUMERIC(28,8),
  ref_id UUID, status public.tx_status, description TEXT,
  created_at TIMESTAMPTZ NOT NULL DEFAULT now()
);
...
CREATE TABLE public.copy_experts (
  ...
  win_rate NUMERIC(5,2), followers INT NOT NULL DEFAULT 0,
  active BOOLEAN NOT NULL DEFAULT true,
  created_at TIMESTAMPTZ NOT NULL DEFAULT now()
);
...
CREATE TABLE public.kyc_records (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  user_id UUID NOT NULL REFERENCES auth.users(id) ON DELETE CASCADE,
  doc_type TEXT NOT NULL, doc_url TEXT,
  status public.kyc_status NOT NULL DEFAULT 'pending',
  admin_note TEXT, id_front_url TEXT, id_back_url TEXT, selfie_url TEXT, full_address TEXT,
...
CREATE TABLE public.exchange_transactions (
  ...
  user_id UUID NOT NULL,
  kind TEXT NOT NULL,
  from_asset TEXT NOT NULL, to_asset TEXT NOT NULL,
  from_amount NUMERIC(28,8) NOT NULL, to_amount NUMERIC(28,8) NOT NULL,
...
CREATE TABLE public.balance_adjustments (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  admin_id UUID NOT NULL, user_id UUID NOT NULL,
  asset TEXT NOT NULL, delta NUMERIC(28,8) NOT NULL, reason TEXT,
  created_at TIMESTAMPTZ NOT NULL DEFAULT now()
);
